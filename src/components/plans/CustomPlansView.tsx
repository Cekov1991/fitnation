...
export function CustomPlansView({
  ...
  const allPlans = useMemo(() => {
    return plans
      .filter((plan: PlanResource) => !plan.is_active)
  ...
  const handleContinueWorkout = () => {
    ...
    if (activeSession?.id) {
      onContinueSession(activeSession.id);
      setOpenMenuId(null);
    }
  };
    ...
    <>
          ...
          >
            ...
            >
              <div className="flex justify-between items-start mb-4">
                ...
                {activePlan && (
                  <button 
                    onClick={e => handlePlanMenuClick(e, 'active-plan', {
                      id: activePlan.id,
              ...
              <div className="space-y-3">
                ...
                {activePlanWorkouts.map((workout: any, index: number) => (
                  <div 
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <button 
                        onClick={e => handleWorkoutMenuClick(e, `workout-${index}`, {
              ...
              allPlans.map((plan: any) => (
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <button 
                      onClick={e => handlePlanMenuClick(e, `plan-${plan.id}`, plan)} 
                      className="p-2 rounded-full transition-colors" 
                      style={{ backgroundColor: 'var(--color-border-subtle)' }}
                    >
                  ...
                  {plan.workoutList.length > 0 && (
                    <>
                      ...
                      <div className="space-y-2">
                        {plan.workoutList.map((workout: any, idx: number) => (
                          <div 
      ...
      {menuType === 'plan' && (
        <PlanMenu 
          ...
          isActive={currentMenuPlan?.isActive ?? false} 
          onAddWorkout={handleAddWorkout} 
          onEdit={handleEditPlan} 
          onToggleActive={handleToggleActive} 
          onDelete={handleDeletePlanClick} 
          isToggleLoading={updatePlan.isPending} 
          isDeleteLoading={deletePlan.isPending} 
        />
      )}
